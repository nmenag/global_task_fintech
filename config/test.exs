...
config :global_task_fintech, GlobalTaskFintechWeb.Endpoint,
  ...
  secret_key_base: "/4QcD2QxyXpHBylbG+NwrtwKdylC2HeLbMBycm7ZE28kyTXnUOFAo4BQrFnupKNx",
  server: false

# In test we don't send emails
config :global_task_fintech, GlobalTaskFintech.Mailer, adapter: Swoosh.Adapters.Test
